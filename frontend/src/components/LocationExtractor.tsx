...
const LocationExtractor = () => {
  ...
  const handleLocationExtraction = async () => {
    ...
    try {
      const res = await fetch("https://disaster-management-k7ux.vercel.app/api/geocode_location/location", {
        method: "POST",
  ...
  const handleManualGeocoding = async () => {
    ...
    try {
      const res = await fetch("https://disaster-management-k7ux.vercel.app/api/geocode/", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
